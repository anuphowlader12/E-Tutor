		...
		switch ( $type ) {
			case 'success':
				$body .= sprintf(
					...
					__( 'Hello! Your site at %1$s has been updated automatically to WordPress %2$s.' ),
					home_url(),
					$core_update->current
				);
				$body .= "\n\n";
		...
		switch ( $type ) {
			case 'success':
				if ( $successful_plugins && $successful_themes ) {
					...
					$body[]  = sprintf(
						...
						__( 'Hello! Some plugins and themes have automatically updated to their latest versions on your site at %s. No further action is needed on your part.' ),
						home_url()
					);
					...
					$body[]  = sprintf(
						/* translators: %s: Home URL. */
						__( 'Hello! Some plugins have automatically updated to their latest versions on your site at %s. No further action is needed on your part.' ),
						home_url()
					);
				} else {
					/* translators: %s: Site title. */
					...
					$body[]  = sprintf(
						/* translators: %s: Home URL. */
						__( 'Hello! Some themes have automatically updated to their latest versions on your site at %s. No further action is needed on your part.' ),
						home_url()
					);
				}
			...
			case 'mixed':
				if ( $failed_plugins && $failed_themes ) {
					...
					$body[]  = sprintf(
						/* translators: %s: Home URL. */
						__( 'Hello! Plugins and themes failed to update on your site at %s.' ),
						home_url()
					);
					...
					$body[]  = sprintf(
						/* translators: %s: Home URL. */
						__( 'Hello! Plugins failed to update on your site at %s.' ),
						home_url()
					);
				} else {
					/* translators: %s: Site title. */
					...
					$body[]  = sprintf(
						/* translators: %s: Home URL. */
						__( 'Hello! Themes failed to update on your site at %s.' ),
						home_url()
					);
				}
